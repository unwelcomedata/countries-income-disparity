...
<style>
  ...
  .backhome-wrap {{ text-align: center; margin: 32px 0 8px; }}
  .backhome {{ display: inline-block; padding: 14px 28px; font-size: 18px;
               font-weight: 700; color: #fff; background: #005F73;
               border-radius: 8px; text-decoration: none; }}
  .backhome:hover {{ background: #00485a; }}
</style>
</head>
<body>
<div class="wrap">
...
{chr(10).join(options)}
  ...
  <div class="backhome-wrap">
    <a class="backhome" href="../">&larr; Back to How Countries Compare</a>
  </div>
</div>
<script>
  function swap() {{
